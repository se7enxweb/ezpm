  ...
  <div id="usermenu">
    ...
    <div id="links">
        ...
        {if $current_user.is_logged_in}
            ...
            {/if}
            <li><a href={"/pm/list_inbox"|ezurl} title="{'Private messaging'|i18n('content/standard/ezpm')}">{'Private messaging'|i18n('content/standard/ezpm')}</a></li>
        {else}
        ...
        {if $pagedesign.can_edit}
            <li><a href={concat( "/content/edit/", $pagedesign.id, "/a" )|ezurl} title="{$pagedesign.data_map.site_settings_label.data_text|wash}">{$pagedesign.data_map.site_settings_label.data_text|wash}</a></li>
        {/if}
        </ul>
    </div>
    </div>
...
{/cache-block}
    <div id="sidemenu-position">
      <div id="sidemenu">
          ...
          {include uri='design:menu/pm_menu.tpl'}
       </div>
    </div>
    <!-- Side menu area: END -->
